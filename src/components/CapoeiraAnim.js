...
export default function ModelCap({ ...props }) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/capoeiraAnim.glb')
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene" rotation={[0, 30.5, 0]}>
        <group name="Armature">
...
useGLTF.preload('/capoeiraAnim.glb')
